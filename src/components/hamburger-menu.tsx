...
type HamgurgerMenuProps = { links : Link[] };

const HamgurgerMenu : React.FC<HamgurgerMenuProps> =({ links }) => {
       ...
       <div className='md:hidden top-5 right-5 fixed w-60 z-[999] flex flex-col items-end gap-2'>
        ...
        <AnimatePresence>
           {isOpen && (
             ...
             initial="start"
             animate="visible"
             className='w-full bg-white drop-shadow border border-slate-400 dark:border-white shadow-2xl rounded-2xl flex  flex-col items-center justify-center dark:bg-gray-950 p-1'
             >
